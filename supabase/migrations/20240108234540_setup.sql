...
AS $$
DECLARE
  project_url TEXT := 'https://nqonetcwthmeyqwlsgpw.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5xb25ldGN3dGhtZXlxd2xzZ3B3Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNzkyNjI0MSwiZXhwIjoyMDIzNTAyMjQxfQ.NBCktbOzRD7ICZIakcxMnNEkW8ESjJcB65qCxQHG0Zk'; -- full access needed for http request to storage
