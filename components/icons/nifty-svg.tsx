...
export const NiftySVG: FC<NiftySVGProps> = ({ theme, scale = 1 }) => {
  // Determine fill color based on the theme
  const fillColor = theme === "dark" ? "#FFFFFF" : "#0C73FE"
  ...
  return (
    ...
    >
      <path
        ...
        fill={fillColor}
      />
      <path d="M46 38V18H42V14H46V4H50V14H54V18H50V38H46Z" fill={fillColor} />
      <path
        d="M32 38V14C32 8.47715 36.4772 4 42 4V8C38.6863 8 36 10.6863 36 14H40V18H36V38H32Z"
        fill={fillColor}
      />
      <path d="M24 38V14H28V38H24Z" fill={fillColor} />
      <path
